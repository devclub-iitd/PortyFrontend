    ...
    <div className="fullScreenInside">
      <div>
        ...
        <Typography className={classes.steps}>
          ...
          <br />
          2) Create a new repository in your account with the name as username.github.io
          where username is your github username.
          <br />
          3) Click the Download button on the homepage
          to a download a file named - &quot;file.json&quot;
          <br />
      ...
      <div className="buttonRow">
        <div className="buttonColumn">
          ...
          <br />
          <Button variant="outlined" onClick={design1}>View</Button>
        </div>
        <div className="buttonColumn">
