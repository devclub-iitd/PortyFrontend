...
import Landing from '../components/portfolio_3/landing';
import About from '../components/portfolio_3/about';
import Education from '../components/portfolio_3/education';
import Work from '../components/portfolio_3/work';
import Volunteer from '../components/portfolio_3/volunteer';
import Extra from '../components/portfolio_3/extra';
import Contact from '../components/portfolio_3/contact';


import Loader from '../components/loader';

import '../style/portfolio_3.css';
...
const Portfolio = ({
  ...
  if (!loading && profile !== null && !auth.loading && auth.isAuthenticated) {
    return (
      <div class="portfolioContainerFull3">
        <Landing
