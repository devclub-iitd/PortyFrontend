...
import AchIcon from '@material-ui/icons/Inbox';
import SettingsIcon from '@material-ui/icons/Settings';

import About from '../components/reg/about.js'
import Education from '../components/reg/education.js'
import LoginDet from '../components/reg/loginDet.js'
      ...
      <Router>
        <div>
          ...
          <Paper className={classes.rootRegPage}>
            {this.state.value === 0 && <TabContainer> <About submit = {this.handleSubmit}/> </TabContainer>}
          </Paper>
